import { saveBaseByChannel, loadBaseByChannel } from "./firebase.js";
import { episodes } from "./youtube.js";
...
async function load(){
  const cloud = await loadBaseByChannel(CHANNEL);
...
saveBtn.addEventListener("click", async () => {
  ...
  await saveBaseByChannel(CHANNEL, data);
